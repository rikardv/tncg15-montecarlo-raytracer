...
public class Scene {
    ...
    Rectangle W6 = new Rectangle(new Vertex(-3,0,-5),new Vertex(0,6,-5),new Vertex(0,6,5),new Vertex(-3,0,5),0,150,150);
    Rectangle test = new Rectangle(new Vertex(10,-1,-1),new Vertex(10,1,-1),new Vertex(10,1,1),new Vertex(10,-1,1),0,0,255);

    /**
     * Floor
     */
    Rectangle Floor_W1 = new Rectangle(new Vertex(10,6,-5),new Vertex(0,6,-5),new Vertex(0,-6,-5),new Vertex(10,-6,-5),255,165,0);
    Triangle Floor_W2 = new Triangle(new Vertex(0,6,-5), new Vertex(-3,0,-5), new Vertex(0,-6,-5), 255,165,0);
    Triangle Floor_W3 = new Triangle(new Vertex(10,-6,-5), new Vertex(13,0,-5), new Vertex(10,6,-5), 255,165,0);

    /**
     * Roof
     */
    Rectangle Roof_W1 = new Rectangle(new Vertex(10,6,5),new Vertex(10,-6,5),new Vertex(0,-6,5),new Vertex(0,6,5),255,255,0);
    Triangle Roof_W2 = new Triangle(new Vertex(0,6,5), new Vertex(0,-6,5), new Vertex(-3,0,5), 255, 255, 0);
    Triangle Roof_W3 = new Triangle(new Vertex(10,6,5), new Vertex(13,0,5), new Vertex(10,-6,5), 255, 255, 0);
